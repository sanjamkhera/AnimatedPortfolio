        ...
        <div className='p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lag:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:1/2'>
          ...
          <div className='flex flex-col gap-12 justify-center' ref={skillRef}>
            ...
            <motion.div
              ...
              <div className='rounded p-2 text-sm cursor-pointer bg-black text-white hover:bg-white hover:text-black'>GraphSQL</div>
            ...
            <motion.div
              ...
              <div className='flex justify-between h-48'>
                ...
                <div className='w-1/3'>
                  ...
                  {/* JOB COMPANY */}
                  <div className='p-1 rounded bg-white text-sm font-semibold w-fit'>Apple Inc.</div>
                </div>
                {/* CENTER */}
